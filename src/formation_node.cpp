...
public:
    ...
    FormationNode(): nh_("~"), controller(2.09, 2.0, 8.0, 2, 2, 2)
    {
        ...
        target_sub = n.subscribe<nav_msgs::Odometry>("/target", 1, &FormationNode::target_callback, this);
        obstacles_sub = n.subscribe<geometry_msgs::PoseArray>("/obstacles", 1, &FormationNode::obs_callback, this);
        ...
        timer = n.createTimer(ros::Duration(0.1), &FormationNode::timerCallback,this);
