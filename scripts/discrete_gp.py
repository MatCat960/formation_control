...
targets = np.array(([7.0, 8.0], [15.0, 15.0]))
targets.shape
target = targets[0]
...
for s in range(1, NUM_STEPS+1):
  ...
  imgpath = path / f"pics/timevar/img{s}.png" if TIME_VAR else path / f"pics/uncertain/img{s}.png"
  plt.savefig(imgpath)
  # plt.show()
  plt.close()
...
finalpath = path / "pics/timevar/final.png" if TIME_VAR else path / "pics/uncertain/final.png"
