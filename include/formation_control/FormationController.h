...
namespace formation_control
{
    ...
    public:
        FormationController(double fow_angle, double min_distance, double max_distance, int num_robots, int max_obstacles);
        ~FormationController();
        int applyCbf(Eigen::Vector3d &uopt, Eigen::Vector3d &ustar, Eigen::MatrixXd &p_j_i, Eigen::MatrixXd &obs_i, Eigen::VectorXd &h_out);
